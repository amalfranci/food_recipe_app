...
import { removeFromCart } from "../redux/favouriteSlice";

function Favorite() {
  const meals = useSelector((state) => state.favorite.value);
    ...
    <section className="min-h-screen">
      <div className="container px-5 py-24 mx-auto">
        ...
        <div className="flex flex-wrap lg:w-3/4 w-full sm:mx-auto sm:mb-2 -mx-2">
          {meals.length === 0 ? (
            <p className="text-center w-full text-lg">No Meal Found...</p>
          ) : (
            meals.map((meal) => (
