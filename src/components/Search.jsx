      ...
      <div className="overlay">
        <div className="container px-5 py-7 mx-auto ">
          ...
          <p className="text-center mb-5 text-md-">
            Discover lots of recipes and learn how to make them. If you like a
          ...
          <div className="w-full lg:w-2/3 mx-auto">
            ...
            >
              <input
                type="text"
                className=" w-full bg-transparent outline-none search-bar text-cyan-700"
              ...
              <button className="font-bold">
                <CiSearch size={25} className="text-green-500" />
              </button>
            </form>
          </div>
        </div>
